...
class HandDetector():
    ...
    def findHands(self , img , draw=True):
        ...
        # landmark_drawing_spec = self.mpDraw.DrawingSpec(color=(255, 55, 255), thickness=2, circle_radius=2)
        # connection_drawing_spec = self.mpDraw.DrawingSpec(color=(2, 255, 2), thickness=1, circle_radius=2)  # White connections
